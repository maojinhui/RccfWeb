...
public class JavaSmsApi {
    ...
    @Autowired
    private static SpyMemcachedManager spyMemcachedManager;
...
//        String code = "1234";
    ...
    public static String sendSms(String code ,String mobile) throws IOException {
        ...
        Map<String, String> params = new HashMap<String, String>();
        params.put("apikey", AccountConstants.SMS_API_KEY);
        String text = "【铁帮主】验证码是" + code + "，此验证码十分钟之内有效。";
        params.put("text", text);
        String phone = URLEncoder.encode(mobile, ENCODING);
        params.put("mobile", phone);
        String data = post(URI_SEND_SMS, params);
        return data;
    }
