...
<div class="am-padding am-u-sm-12">
    ...
    <table class="am-table am-table-bordered ">
        ...
        <tr>
            <td>城六区</td>
            <td colspan="3">
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="1" type="checkbox" <%=area&&aproduce.getHouseArea().contains("1")?"checked='checked'":""%>>  朝阳区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="2" type="checkbox" <%=area&&aproduce.getHouseArea().contains("2")?"checked='checked'":""%>>  海淀区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="3" type="checkbox" <%=area&&aproduce.getHouseArea().contains("3")?"checked='checked'":""%>>  东城区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="4" type="checkbox" <%=area&&aproduce.getHouseArea().contains("4")?"checked='checked'":""%>>  西城区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="5" type="checkbox" <%=area&&aproduce.getHouseArea().contains("5")?"checked='checked'":""%>>  丰台区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="6" type="checkbox" <%=area&&aproduce.getHouseArea().contains("6")?"checked='checked'":""%>>  石景山区</span>
            </td>
        </tr>
        <tr>
            <td>近郊区域</td>
            <td colspan="3">
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="7" type="checkbox" <%=area&&aproduce.getHouseArea().contains("7")?"checked='checked'":""%>>  顺义区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="8" type="checkbox" <%=area&&aproduce.getHouseArea().contains("8")?"checked='checked'":""%>>  房山区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="9" type="checkbox" <%=area&&aproduce.getHouseArea().contains("9")?"checked='checked'":""%>>  通州区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="10" type="checkbox" <%=area&&aproduce.getHouseArea().contains("10")?"checked='checked'":""%>>  大兴区</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="11" type="checkbox" <%=area&&aproduce.getHouseArea().contains("11")?"checked='checked'":""%>>  亦庄</span>
                <span class="am-margin-right-xl am-margin-left"><input name="produce_area" value="12" type="checkbox" <%=area&&aproduce.getHouseArea().contains("12")?"checked='checked'":""%>>  昌平</span>
            </td>
        </tr>
        <tr>
            <td>远郊区域</td>
    ...
    <table class="am-table am-table-bordered ">
        ...
        <tr>
            ...
            <td colspan="3">
                <span class="am-margin-right-xl am-margin-left">
                    <input name="house_nature" value="1" type="checkbox" <%=applyLoanHouseNature&&aproduce.getApplyHouseNature().contains("1")?"checked='checked'":""%>>  住宅</span>
                <span class="am-margin-right-xl am-margin-left">
                    <input name="house_nature" value="2" type="checkbox" <%=applyLoanHouseNature&&aproduce.getApplyHouseNature().contains("2")?"checked='checked'":""%>>  70年产权公寓</span>
                <span class="am-margin-right-xl am-margin-left">
                    <input name="house_nature" value="3" type="checkbox" <%=applyLoanHouseNature&&aproduce.getApplyHouseNature().contains("3")?"checked='checked'":""%>>  成本价</span>
                <span class="am-margin-right-xl am-margin-left">
                    <input name="house_nature" value="4" type="checkbox" <%=applyLoanHouseNature&&aproduce.getApplyHouseNature().contains("4")?"checked='checked'":""%>>  商住</span>
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td colspan="3">
                ...
                <span class="am-margin-right-xl am-margin-left"><input name="house_nature" value="11" type="checkbox" <%=applyLoanHouseNature&&aproduce.getApplyHouseNature().contains("11")?"checked='checked'":""%>>  按经适房管理(2008年4月11日之前)</span>
            </td>
        </tr>
        <%
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <span class="am-margin-right-xl am-margin-left"><input name="folk_diya_affect" value="0" type="radio" <%=folkaffect&&aproduce.getFolkMortgageAffect()==1?"checked='checked'":""%>>  否</span>
            </td>
        </tr>
        <%
